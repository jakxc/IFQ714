...
/**
 * Displays a flight in console with table format
 *
 * @param {object} the flight to display
 *
 */
...
/**
 * Displays array of flights in console with table format
 *
 * @param {object} the dataset to display
 *
 */
...
export function sortByDistance(dataset) {
    ...
    return dataset.sort((a,b) => {
        if (!a['direct_distance'] || !b['direct_distance']) return 0;
...
export function sortByNumberOfAircrafts(dataset) {
    ...
    return dataset.sort((a,b) => {
        if (!a['aircraft'] || !b['aircraft']) return 0;
