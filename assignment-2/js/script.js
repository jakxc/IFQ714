...
function main() {
    // const parsedAirportsData = parseData(readFileSync("../data/A2_Airports.json", "utf8"));
    // const parsedFlightsData = parseData(readFileSync("../data/A2_Flights.json", "utf8"));
    // const combinedData = [];
    ...
    //     })
    // })
    // exportDataToFile("../data/Combined_Data.json", combinedData);

    const parsedCombinedData = JSON.parse(readFileSync("../data/Combined_Data.json", "utf8"));
    const combinedDataWithDistance = mapData(parsedCombinedData, mapDirectDistanceBetweenAirports).data;
